            ...
            <Content>
                ...
                <div className="right">
                    <div className="content-right">
                        ...
                        ainda, é claro.
                        <br></br><br></br>
                        Por isso, criamos o CLUBE DIPLOMADO UNIPAM. Se você
                        se formou na instituição, já faz parte dele e pode retirar o seu cartão
                        especial de descontos. Com ele, você tem direito a inúmeras
                        <br></br>vantagens. E aí? Isso é ou não é ser especial.</p>
                        <button className="btn-vantagens"><a href="#" alt="Solicitar">Solicitar</a></button>
                    </div>
                </div>
            </Content>
        </Container>
