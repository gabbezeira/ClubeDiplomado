...
export default function Conveniados() {
  ...
  const list = [
    {
      name: "Academia Adriane Gonçalves",
      benef:
        "10% de desconto: Musculação, Passe Livre, Jazz, Ballet, Ginástica Artística. | 10% de desconto no Programa de Emagrecimento: Desafio 30.",
      category: "Academia",
    },
    {
      name: "Pedro",
    ...
    {
      name: "Academia Adriane Gonçalves4",
      benef:
        "10% de desconto: Musculação, Passe Livre, Jazz, Ballet, Ginástica Artística. | 10% de desconto no Programa de Emagrecimento: Desafio 30.",
      category: "Farmacia",
    },
  ...
  useEffect(() => {
    const delayDebounceFn = setTimeout(() => {
      ...
      const results = list.filter(
        (list) =>
          list.category.toLowerCase().indexOf(searchTerm.toLowerCase()) !== -1
      );
